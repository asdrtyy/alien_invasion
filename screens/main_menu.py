...
def main_menu():
    ...
    def draw_levels_menu():
        ...
        level1_btn = Button(screen, text="Level 1", center=(settings.screen_width//2, settings.screen_height//2-180), width=400, height=100, font_path=retro_font_path, font_size=50)
        level2_btn = Button(screen, text="Level 2", center=(settings.screen_width//2, settings.screen_height//2-60), width=400, height=100, font_path=retro_font_path, font_size=50)
        level3_btn = Button(screen, text="Level 3", center=(settings.screen_width//2, settings.screen_height//2+60), width=400, height=100, font_path=retro_font_path, font_size=50)
        level4_btn = Button(screen, text="Level 4", center=(settings.screen_width//2, settings.screen_height//2+180), width=400, height=100, font_path=retro_font_path, font_size=50)
        level5_btn = Button(screen, text="Level 5", center=(settings.screen_width//2, settings.screen_height//2+300), width=400, height=100, font_path=retro_font_path, font_size=50)
        endless_btn = Button(screen, text="Endless", center=(settings.screen_width//2, settings.screen_height//2+420), width=400, height=100, font_path=retro_font_path, font_size=50, bg_color=(20,40,20), hover_color=(40,80,40))
        while show_levels[0]:
            ...
            screen.blit(title, title.get_rect(center=(settings.screen_width//2, settings.screen_height//2-300)))
            level1_btn.draw()
            level2_btn.draw()
            level3_btn.draw()
            level4_btn.draw()
    ...
    music_on_img = pygame.image.load(os.path.join(os.path.dirname(__file__), '../images/music_on.png')).convert_alpha()
    music_off_img = pygame.image.load(os.path.join(os.path.dirname(__file__), '../images/music_off.png')).convert_alpha()
    music_on_img = pygame.transform.smoothscale(music_on_img, (music_btn_size, music_btn_size))
    music_off_img = pygame.transform.smoothscale(music_off_img, (music_btn_size, music_btn_size))
    ...
    while True:
        ...
        screen.blit(title_text, title_text.get_rect(center=(settings.screen_width // 2, settings.screen_height // 4)))
        play_button.draw()
        levels_button.draw()
        exit_button.draw()
        # Кнопка музыки
